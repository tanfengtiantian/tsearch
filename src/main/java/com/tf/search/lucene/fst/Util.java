...
import java.util.*;
import static com.tf.search.lucene.fst.FST.*;
...
public final class Util {
  ...
  public static IntsRef getByOutput(FST<Long> fst, long targetOutput) throws IOException {
    ...
    // TODO: would be nice not to alloc this on every lookup
    Arc<Long> arc = fst.getFirstArc(new FST.Arc<Long>());
   ...
   */
  public static IntsRef getByOutput(FST<Long> fst, long targetOutput, BytesReader in, Arc<Long> arc, FST.Arc<Long> scratchArc, IntsRefBuilder result) throws IOException {
