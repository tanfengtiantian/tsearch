 ...
 */
package com.tf.search.lucene.fst;



import com.tf.search.lucene.codecs.CodecUtil;
import com.tf.search.lucene.codecs.CorruptIndexException;
import com.tf.search.lucene.store.ByteArrayDataOutput;
import com.tf.search.lucene.store.DataInput;
import com.tf.search.lucene.store.DataOutput;
import com.tf.search.lucene.store.InputStreamDataInput;
import com.tf.search.lucene.store.OutputStreamDataOutput;
import com.tf.search.lucene.store.RAMOutputStream;
import com.tf.search.lucene.utils.Accountable;
import com.tf.search.lucene.utils.ArrayUtil;
import com.tf.search.lucene.utils.Constants;
import com.tf.search.lucene.utils.RamUsageEstimator;
import com.tf.search.lucene.store.*;
import java.io.*;
