 ...
 */
package com.tf.search.lucene.utils.packed;



import com.tf.search.lucene.utils.Accountable;
import com.tf.search.lucene.utils.LongValues;
import com.tf.search.lucene.utils.RamUsageEstimator;
import static  com.tf.search.lucene.utils.packed.PackedInts.checkBlockSize;
import static  com.tf.search.lucene.utils.packed.PackedInts.numBlocks;

/**
 * Base implementation for { PagedMutable} and {@link PagedGrowableWriter}.
 * @lucene.internal
 */
